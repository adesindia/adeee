...
<html lang="en">
  <head>
    ...
    <title>My Portofolio | Ade Sindia</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary shadow-sm ">
      ...
      <section class="jumbotron text-center">
        <img src="img/ade.jpg.jpeg" alt="ade sindia" width="200"class="rounded-circle img-thumbnail">
        ...
        <section id="projects">
          <div class="container">
            ...
            <div class="row">
              <div class="col-4">
                <div class="card">
                  <img src="img/project/php.jpg" class="card-img-top" alt="project 1">
                  <div class="card-body">
              ...
              <div class="col-4"> 
                <div class="card">
                  <img src="img/project/html.jpg" class="card-img-top" alt="project 1">
                  <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                </div>
              ...
              <div class="col-4">
                <div class="card">
                  <img src="img/project/mysql.jpg" class="card-img-top" alt="project 1">
                  <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                </div>
...
<footer class ="bg-primary text-white text-center">
  <p>Created With love By<a href="https://www.instagram.com/snowpinksin/" class="text-white fw-blod">sindia</a></p>
</footer>
<!-- Akhir Footer -->
